...
class _WorkoutListScreenState extends State<WorkoutListScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final weeklyWorkouts = _calculateWeeklyWorkouts(workouts);
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFF7B2FF2), // Violet
              Color(0xFF1E90FF), // Bleu
            ],
          ),
        ),
            ...
            SliverAppBar(
              ...
              actions: [
                Container(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.lightbulb_outline, color: Colors.white, size: 24),
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WorkoutSuggestionScreen(),
                        ),
                      );
                    },
                                    ...
                                    PopupMenuButton<String>(
                                      ...
                                      itemBuilder: (context) => [
                                        PopupMenuItem(
                                          ...
                                          child: Row(
                                            children: [
                                              Icon(Icons.edit_rounded, color: Color(0xFF3B82F6), size: 20),
                                              SizedBox(width: 12),
                                              Text('Modifier'),
                                            ],
                                          ),
